...
// UTILITÁRIOS
// ══════════════════════════════════════════
function setToday() { const d = new Date().toISOString().split('T')[0]; document.getElementById('f-emissao').value = d; document.getElementById('f-recebimento').value = d; document.getElementById('lanc-data').value = d; }
...
function populateSelects() {
  ...
  document.getElementById('lanc-obra').innerHTML = opts;
