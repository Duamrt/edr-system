...
const PciModule = {
  ...
  _SUBS: [
    // t1 — Serviços Preliminares e Gerais
    { categoria_id:'t1', descricao:'Limpeza do Terreno', ordem:1 },
    { categoria_id:'t1', descricao:'Gabarito', ordem:2 },
    { categoria_id:'t1', descricao:'Locação', ordem:3 },
    // t2 — Infraestrutura
    { categoria_id:'t2', descricao:'Escavação das Sapatas e Arranques', ordem:1 },
    { categoria_id:'t2', descricao:'Concretagem de Sapatas e Arranques', ordem:2 },
    { categoria_id:'t2', descricao:'Escavação do Baldrame', ordem:3 },
    { categoria_id:'t2', descricao:'Embasamento', ordem:4 },
    { categoria_id:'t2', descricao:'Montagem das Ferragens do Baldrame', ordem:5 },
    { categoria_id:'t2', descricao:'Forma + Esgoto', ordem:6 },
    { categoria_id:'t2', descricao:'Concretagem das Vigas Baldrame', ordem:7 },
    { categoria_id:'t2', descricao:'Remoção das Formas', ordem:8 },
    { categoria_id:'t2', descricao:'Regularização do Piso', ordem:9 },
    // t3 — Supra Estrutura
    { categoria_id:'t3', descricao:'Amarração dos Pilares nos Arranques', ordem:1 },
    { categoria_id:'t3', descricao:'03 Fiadas de Alvenaria Impermeabilizada', ordem:2 },
    { categoria_id:'t3', descricao:'Alvenaria até 8 Fiadas', ordem:3 },
    { categoria_id:'t3', descricao:'Passagem de Tubos e Eletrodutos nos Pilares', ordem:4 },
    { categoria_id:'t3', descricao:'Concretagem 1º Lance de Pilar', ordem:5 },
    { categoria_id:'t3', descricao:'Vergas e Contravergas', ordem:6 },
    { categoria_id:'t3', descricao:'Conferir Nível Antes da Última Fiada', ordem:7 },
    { categoria_id:'t3', descricao:'Concretagem 2º Lance de Pilar até Fundo de Viga', ordem:8 },
    { categoria_id:'t3', descricao:'Montagem das Ferragens das Vigas Superiores', ordem:9 },
    { categoria_id:'t3', descricao:'Forma das Vigas Superiores', ordem:10 },
    { categoria_id:'t3', descricao:'Passagens nas Vigas para Eletrodutos', ordem:11 },
    { categoria_id:'t3', descricao:'Concretagem das Vigas Superiores', ordem:12 },
    { categoria_id:'t3', descricao:'Montagem da Laje', ordem:13 },
    { categoria_id:'t3', descricao:'Escoramento da Laje', ordem:14 },
    { categoria_id:'t3', descricao:'Concretagem da Laje', ordem:15 },
    // t4 — Paredes e Painéis
    { categoria_id:'t4', descricao:'Corte das Alvenarias para Elétrica e Hidráulica', ordem:1 },
    { categoria_id:'t4', descricao:'Chumbamento dos Eletrodutos nas Paredes', ordem:2 },
    { categoria_id:'t4', descricao:'Chapisco até Fundo de Viga', ordem:3 },
    { categoria_id:'t4', descricao:'Mestrar para Ajustar Ambiente Fora de Esquadro', ordem:4 },
    { categoria_id:'t4', descricao:'Reboco Interno', ordem:5 },
    { categoria_id:'t4', descricao:'Instalação das Caixas 4x2', ordem:6 },
    { categoria_id:'t4', descricao:'Reboco Externo', ordem:7 },
    { categoria_id:'t4', descricao:'Enquadramento das Janelas (Capeaços)', ordem:8 },
    // t5 — Esquadrias
    { categoria_id:'t5', descricao:'Instalação das Grades de Portas', ordem:1 },
    { categoria_id:'t5', descricao:'Janelas e Portas de Vidro', ordem:2 },
    { categoria_id:'t5', descricao:'Porta Social e Portão de Garagem', ordem:3 },
    // t6 — Vidros e Plásticos
    { categoria_id:'t6', descricao:'Instalação de vidros', ordem:1 },
    { categoria_id:'t6', descricao:'Instalação de PVC (rodapes, peitoris)', ordem:2 },
    // t7 — Coberturas
    { categoria_id:'t7', descricao:'Alvenaria Platibanda', ordem:1 },
    { categoria_id:'t7', descricao:'Alvenaria Base da Caixa D\'água', ordem:2 },
    { categoria_id:'t7', descricao:'Laje Caixa D\'água', ordem:3 },
    { categoria_id:'t7', descricao:'Escoramento das Telhas em Alvenaria', ordem:4 },
    { categoria_id:'t7', descricao:'Instalação da Calha', ordem:5 },
    { categoria_id:'t7', descricao:'Instalação da Caixa D\'água + Ligação Água', ordem:6 },
    { categoria_id:'t7', descricao:'Instalação das Telhas de Fibrocimento', ordem:7 },
    { categoria_id:'t7', descricao:'Aplicação dos Rufos', ordem:8 },
    { categoria_id:'t7', descricao:'Reboco Externo da Platibanda', ordem:9 },
    // t8 — Impermeabilizações
    { categoria_id:'t8', descricao:'Impermeabilização de fundações', ordem:1 },
    { categoria_id:'t8', descricao:'Impermeabilização de laje', ordem:2 },
    { categoria_id:'t8', descricao:'Impermeabilização de áreas molhadas', ordem:3 },
    // t9 — Revestimentos Internos
    { categoria_id:'t9', descricao:'Piso — Paginação e Aplicação', ordem:1 },
    { categoria_id:'t9', descricao:'Revestimento Paredes Banheiro', ordem:2 },
    { categoria_id:'t9', descricao:'Revestimento Paredes Cozinha', ordem:3 },
    { categoria_id:'t9', descricao:'Revestimento Área de Serviço', ordem:4 },
    // t10 — Forros
    { categoria_id:'t10', descricao:'Retirada das Escoras da Laje', ordem:1 },
    { categoria_id:'t10', descricao:'Audalio — Tubulações do Teto', ordem:2 },
    { categoria_id:'t10', descricao:'Renato — Gesso / Drywall', ordem:3 },
    // t11 — Revestimentos Externos
    { categoria_id:'t11', descricao:'Chapisco externo', ordem:1 },
    { categoria_id:'t11', descricao:'Emboço e reboco externo', ordem:2 },
    { categoria_id:'t11', descricao:'Tratamento de fachada', ordem:3 },
    // t12 — Pintura
    { categoria_id:'t12', descricao:'Vagner — Pintura', ordem:1 },
    // t13 — Pisos
    { categoria_id:'t13', descricao:'Piso em Concreto', ordem:1 },
    { categoria_id:'t13', descricao:'Granito das Janelas', ordem:2 },
    { categoria_id:'t13', descricao:'Granito Cozinha e Banheiros', ordem:3 },
    // t14 — Acabamentos
    { categoria_id:'t14', descricao:'Limpeza Final da Obra', ordem:1 },
    // t15 — Inst. Elétricas e Telefônicas
    { categoria_id:'t15', descricao:'Audalio — Elétrica Completa', ordem:1 },
    // t16 — Instalações Hidráulicas
    { categoria_id:'t16', descricao:'Instalações Hidráulicas', ordem:1 },
    // t17 — Inst. Esgoto e Águas Pluviais
    { categoria_id:'t17', descricao:'Tubulação de esgoto', ordem:1 },
    { categoria_id:'t17', descricao:'Caixa de inspeção', ordem:2 },
    { categoria_id:'t17', descricao:'Fossa e filtro', ordem:3 },
    { categoria_id:'t17', descricao:'Captação de águas pluviais', ordem:4 },
    // t18 — Louças e Metais
    { categoria_id:'t18', descricao:'Instalação de Louças e Metais', ordem:1 },
    // t19 — Complementos
    { categoria_id:'t19', descricao:'Espelhos e acabamentos elétricos', ordem:1 },
    { categoria_id:'t19', descricao:'Caixas de passagem', ordem:2 }
  ],
