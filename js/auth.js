...
function entrarNoApp() {
  ...
  ['obras','estoque','notas','form','creditos','setup','catalogo','banco','relatorio','diarias','contas-pagar'].forEach(name => {
...
async function fazerLogout() {
  ...
  leadsData = []; diarQuinzenas = []; diarQuinzenaAtiva = null; contasPagar = [];
...
function aplicarPerfil() {
  ...
  ['nav-dashboard','nav-obras','nav-estoque','nav-notas','nav-form','nav-creditos',
   'nav-catalogo','nav-relatorio','nav-banco','nav-setup','nav-diarias','nav-custos','nav-leads','nav-contas-pagar'].forEach(id => {
